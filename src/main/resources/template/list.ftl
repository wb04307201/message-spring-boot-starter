...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${contextPath}/message/static/bootstrap/5.3.1/css/bootstrap.min.css"/>
    <script type="text/javascript" src="${contextPath}/message/static/bootstrap/5.3.1/js/bootstrap.bundle.min.js"></script>
    <style>
        .table tbody tr td{
            overflow: hidden;
